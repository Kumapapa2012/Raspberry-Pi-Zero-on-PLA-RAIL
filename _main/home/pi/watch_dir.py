...
#
import http.client, urllib.request, urllib.parse, urllib.error, base64, json, datetime, pyinotify, logging, logging.handlers, re, km_8830utils


###############################################################################
# These are from Azure portal
azure_key1 = 'ff6a86fa135f43f98f5519949a7da97a'
azure_key2 = '23ea60489173411493902726cbce83d2'
...
def do_speechToText(sndFile):
	...
	try:
		...
		logger.debug("[Errno {0}] {1}".format(e.errno, e.strerror))
		return json.loads('{}')
